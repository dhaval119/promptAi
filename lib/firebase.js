...
// Only init when we actually have a real API key (avoids build crash on Vercel
// when env vars are missing or during static generation).
...
if (hasValidConfig) {
  ...
  // Client-side but still missing keys — log once so it's obvious in browser console
  console.warn(
