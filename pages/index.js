    ...
    <>
        ...
        <div className="container">
          ...
          <div className="faq-wrapper" id="faq-section">
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={toggleFaq}>
                Do I need to write my input in English?
                <svg className="faq-icon" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
              </div>
              <div className="faq-answer">
                No. You can write in any language—English, Hindi, Hinglish, or mixed. Prompt AI automatically transforms it into a professional English prompt.
              </div>
            </div>

            <div className="faq-item">
              <div className="faq-question" onClick={toggleFaq}>
                Can I use the refined prompts directly in AI tools?
                <svg className="faq-icon" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg>
              </div>
              <div className="faq-answer">
                Yes. Every refined prompt is fully optimized and ready to be pasted into any AI model without modification.
              </div>
            </div>
          </div>
        </div>
      ...
      <style jsx>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .main-heading {
          position: absolute;
          top: 328px; left: 369px;
          font-size: 130px; font-weight: 900;
        }

        .sub-heading {
          position: absolute;
          top: 827px; left: 1184px;
          font-size: 22px; font-weight: bold;
        }

        .nav {
          position: fixed;
          top: 31px; right: 240px;
        ...
        .description {
          position: absolute;
          top: 2083px; left: 107px;
          width: 755px;
          font-size: 25px; font-weight: bold; line-height: 1.8;
        }

        .features-container {
          position: absolute;
          top: 1229px; left: 107px;
          width: 1650px;
        }
        .feature-row {
        ...
        .feature-card {
          width: 502px; height: 176px;
          border-radius: 25px; overflow: hidden; flex-shrink: 0;
        }
        .card-header {
          height: 66px; background: #1e1e1e;
          padding: 21px 32px;
          font-size: 20px; font-weight: bold; color: white;
        }
        .card-body {
          height: 110px; padding: 32px;
        ...
        .second-heading {
          position: absolute;
          top: 3200px; left: 130px;
          font-size: 60px; font-weight: 900;
          width: 1600px; line-height: 1.4;
        }

        .second-btn {
          position: absolute;
          top: 3400px; left: 130px;
        ...
        .second-btn:hover { background: #e0e0e0; }

        .faq-wrapper {
          position: absolute;
          top: 3700px; left: 130px;
          width: 1650px; color: white;
        }
        .faq-heading {
          font-size: 70px; font-weight: 900;
          line-height: 1.1; margin-bottom: 80px;
          letter-spacing: -1px;
        }
        ...
        @media (max-width: 1000px) {
          ...
          .nav { right: 20px; gap: 12px; padding: 4px 14px; }
          .nav a { font-size: 13px; }
          .btn-top { right: 10px; width: 110px; height: 32px; font-size: 12px; }
        }
        @media (max-width: 600px) {
          ...
          .section-title, .title1, .title2, .description,
          .features-container, .main-img, .second-hero,
          .second-heading, .second-btn, .faq-wrapper {
            position: relative !important;
            top: auto !important; left: 20px !important;
            width: 90% !important; margin-top: 40px;
          }
          ...
          .logo { left: 12px; top: 12px; height: 40px; width: 40px; }
        }
      `}</style>
    </>
  );
